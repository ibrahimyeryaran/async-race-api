import { initGarage } from "./src/components/garageController";
...
const renderView = async (view: string): Promise<void> => {
  ...
  document
    .getElementById("garage-btn")
    ?.addEventListener("click", () => renderView("garage"));
  document
    .getElementById("winners-btn")
    ?.addEventListener("click", () => renderView("winners"));
